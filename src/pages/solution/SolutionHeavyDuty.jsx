      ...
      <section className="bg-gradient-to-br from-blue-700 to-blue-900 text-white py-20 px-6">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Built for demanding factory, warehouse, and manufacturing environments — high load capacity, durability, and long service life.
          </p>
        </div>
      </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md border border-slate-100">
              ...
              <p>From 500 kg to several tons per caster — ideal for heavy machinery, carts, and platforms.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-md border border-slate-100">
              <h3 className="text-xl font-semibold mb-4">Durable Materials</h3>
              <p>Polyurethane on cast iron, forged steel, nylon — excellent abrasion, impact & chemical resistance.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-md border border-slate-100">
              <h3 className="text-xl font-semibold mb-4">Floor Protection Options</h3>
              <p>Non-marking treads, shock absorption, low rolling resistance for smooth movement on concrete & tiles.</p>
            </div>
          </div>
        </section>
