      ...
      <div className="w-full py-16 lg:py-24 bg-background-light dark:bg-background-dark">
        <div className="max-w-250 mx-auto px-4">
          ...
          <div className="relative">
            <div className="absolute left-4.75 top-0 bottom-0 w-0.5 bg-slate-200 dark:bg-slate-700 md:left-1/2 md:-ml-px h-[600px] my-15"></div>
            <div className="relative flex items-start mb-12 md:justify-between md:items-center md:flex-row-reverse group">
              <div className="order-1 md:w-[55%] "></div>
              <div className="absolute left-10 w-10 h-10 bg-white dark:bg-slate-800 border-4 border-primary rounded-full flex items-center justify-center z-10 md:left-1/2 md:-ml-5 shadow-sm">
